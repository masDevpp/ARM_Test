...
CODES   = main.cpp vector.s vector_handler.s LED.cpp Startup.cpp Timer.cpp SerialHandler.cpp Memory.cpp Kernel.cpp KernelAsm.s LEDHandler.cpp CommandHandler.cpp String.cpp
OBJ     = *.o
